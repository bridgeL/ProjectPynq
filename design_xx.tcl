...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net mic_data1_0_1 [get_bd_ports mic_data1_0] [get_bd_pins top_0/mic_data1]
  ...
  connect_bd_net -net top_0_top_data1 [get_bd_pins axi_gpio_0/gpio_io_i] [get_bd_pins top_0/top_data1]

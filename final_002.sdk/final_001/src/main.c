...
//      result[idx0 + 6 * idx1] = cos(2*3.14*(idx1-idx0+1))+ sin(2 * 3.14*(idx1 + idx0 + 1))+3.14159265;
    	if(idx0==0)
    		result[idx0 + 6 * idx1]=ourdata6[idx1];
    	else if(idx0==1)
    		result[idx0 + 6 * idx1]=ourdata1[idx1];
		else if(idx0==2)
			result[idx0 + 6 * idx1]=ourdata2[idx1];
		else if(idx0==3)
			result[idx0 + 6 * idx1]=ourdata3[idx1];
		else if(idx0==4)
			result[idx0 + 6 * idx1]=ourdata4[idx1];
		else if(idx0==5)
			result[idx0 + 6 * idx1]=ourdata5[idx1];

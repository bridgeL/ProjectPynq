...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set mic_clk_0 [ create_bd_port -dir O mic_clk_0 ]
  set mic_data1_0 [ create_bd_port -dir I mic_data1_0 ]
  set mic_data2_0 [ create_bd_port -dir I mic_data2_0 ]
  set mic_data3_0 [ create_bd_port -dir I mic_data3_0 ]
  set mic_data4_0 [ create_bd_port -dir I mic_data4_0 ]
  set mic_data5_0 [ create_bd_port -dir I mic_data5_0 ]
  set mic_data6_0 [ create_bd_port -dir I mic_data6_0 ]
  ...
  connect_bd_net -net mic_data1_0_1 [get_bd_ports mic_data1_0] [get_bd_pins test_0/data_x1]
  connect_bd_net -net mic_data2_0_1 [get_bd_ports mic_data2_0] [get_bd_pins top_0/mic_data2]
  connect_bd_net -net mic_data3_0_1 [get_bd_ports mic_data3_0] [get_bd_pins top_0/mic_data3]
  connect_bd_net -net mic_data4_0_1 [get_bd_ports mic_data4_0] [get_bd_pins top_0/mic_data4]
  connect_bd_net -net mic_data5_0_1 [get_bd_ports mic_data5_0] [get_bd_pins top_0/mic_data5]
  connect_bd_net -net mic_data6_0_1 [get_bd_ports mic_data6_0] [get_bd_pins top_0/mic_data6]
  ...
  connect_bd_net -net sys_clk_0_1 [get_bd_ports sys_clk_0] [get_bd_pins top_0/sys_clk]
  connect_bd_net -net test_0_data_x24 [get_bd_pins axi_gpio_0/gpio_io_i] [get_bd_pins test_0/data_x24]
  connect_bd_net -net top_0_mic_clk [get_bd_ports mic_clk_0] [get_bd_pins top_0/mic_clk]
  connect_bd_net -net top_0_top_data2 [get_bd_pins axi_gpio_0/gpio2_io_i] [get_bd_pins top_0/top_data2]
  connect_bd_net -net top_0_top_data3 [get_bd_pins axi_gpio_1/gpio_io_i] [get_bd_pins top_0/top_data3]
  connect_bd_net -net top_0_top_data4 [get_bd_pins axi_gpio_1/gpio2_io_i] [get_bd_pins top_0/top_data4]
  connect_bd_net -net top_0_top_data5 [get_bd_pins axi_gpio_2/gpio_io_i] [get_bd_pins top_0/top_data5]
  connect_bd_net -net top_0_top_data6 [get_bd_pins axi_gpio_2/gpio2_io_i] [get_bd_pins top_0/top_data6]
